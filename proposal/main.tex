...
\label{tab:timeline}
\begin{tabular}{p{1.7cm}p{6.9cm}}
\toprule
\textbf{Week(s)} & \textbf{Milestone / Task} \\
\midrule
...
13 & Distill the student policy with predicted heading and depth latent. \\
14--15 & Conduct ablation studies and full-policy evaluation on standard and newly designed terrains; collect metrics including success rate and heading accuracy; categorize typical failure cases; prepare the final report and demo. \\
\bottomrule
\end{tabular}
\end{table}
